...
class ResourceImportFilesControllerTest < ActionController::TestCase
  ...
  def test_librarian_should_create_resource_import_file
    ...
    old_expressions_count = Expression.count
    ...
    assert_equal old_works_count + 5, Work.count
    assert_equal old_expressions_count + 5, Expression.count
    ...
    assert_equal 2, Item.find_by_item_identifier('10101').manifestation.expressions.first.work.patrons.size
