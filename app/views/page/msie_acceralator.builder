xml.openServiceDescription("xmlns" => "http://www.microsoft.com/schemas/openservicedescription/1.0") do
  ...
  xml.display do
    xml.name LibraryGroup.site_config.display_name.localize
    xml.description t('page.search_catalog_at', :library_name => LibraryGroup.site_config.display_name.localize)
  end
