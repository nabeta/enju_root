class ExpressionMergesController < ApplicationController
  ...
  def index
    if @expression
      @expression_merges = @expression.expression_merges.find(:all, :order => ['expression_merges.id'])
    elsif @expression_merge_list
      @expression_merges = @expression_merge_list.expression_merges.find(:all, :include => 'expression', :order => ['expression_merges.id'])
    else
      @expression_merges = ExpressionMerge.find(:all)
    end
