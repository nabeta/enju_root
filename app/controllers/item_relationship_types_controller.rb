class ItemRelationshipTypesController < ApplicationController
  ...
  def index
    @item_relationship_types = ItemRelationshipType.find(:all)
  ...
  def create
    ...
    respond_to do |format|
      if @item_relationship_type.save
        flash[:notice] = 'ItemRelationshipType was successfully created.'
  ...
  def update
    ...
    respond_to do |format|
      if @item_relationship_type.update_attributes(params[:item_relationship_type])
        flash[:notice] = 'ItemRelationshipType was successfully updated.'
        format.html { redirect_to(@item_relationship_type) }
        format.xml  { head :ok }
      else
